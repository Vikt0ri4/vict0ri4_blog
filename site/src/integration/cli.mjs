...
async function printCliNotice() {
	...
	console.log(`
${colours.bold}kjrin710${colours.reset} · package manager
...
async function init(args) {
	...
	console.log(`\n${colours.bold}kjrin710${colours.reset} · initialising project`);
...
async function info() {
	...
	console.log(`\n${colours.bold}kjrin710 project info${colours.reset}`);
	section("Package");
...
function help() {
	console.log(`
${colours.bold}kjrin710 CLI${colours.reset}
